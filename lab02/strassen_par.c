...
// NU DEPIND UNA DE ALTA INSEAMNA CA POT SA LE PARALELIZEZ
...
int main(int argc, char *argv[]) {
  ...
  pthread_create(&t1, NULL, functionThread1, NULL);
  pthread_create(&t2, NULL, functionThread2, NULL);
  pthread_create(&t3, NULL, functionThread3, NULL);
  pthread_create(&t4, NULL, functionThread4, NULL);
  pthread_create(&t5, NULL, functionThread5, NULL);
  pthread_create(&t6, NULL, functionThread6, NULL);
  pthread_create(&t7, NULL, functionThread7, NULL);
    //le am dat join 
  pthread_join(&t1);
  pthread_join(&t2);
  pthread_join(&t3);
